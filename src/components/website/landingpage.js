...
<div className="home-container">
      ...
      <div data-role="Header" className="home-navbar-container">
        <div className="home-navbar">
          ...
          <div className="home-right-side">
            <button className="home-cta-btn Anchor button"  >APPLY NOW</button>
          </div>
        ...
        <div className="home-content-container">
          <div className="home-hero-text">
            <h1 className="home-heading Section-Heading">
              Welcome to Almumin High School
            </h1>
            ...
            <button className="home-cta-btn1 Anchor button">APPLY NOW</button>
          </div>
        </div>
      </div>
      <div id="inspiration" className="home-features">
        <div className="home-heading-container">
          <h2 className="home-text01 Section-Heading">
            About Almumin Boys High School
          </h2>
        </div>
      ...
      <div className="home-team">
        <div className="home-heading-container2">
          <h1 className="home-text16 Section-Heading">Meet the Teaching Team </h1>
        ...
        <div className="home-content-container6">
          ...
          <div className="home-locations-container">
            <div className="home-location-1">
              <span className="home-heading09">Nakuru, Kenya</span>
